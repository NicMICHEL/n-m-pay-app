...
insert into u_user(u_email,u_password,u_account_balance,u_self_account) values('ben@gmail.com','$2a$10$8bnNdaKTiLM80qkCjJBePuYpCiO.3Db.MI602u3lDyPq3YsLXSMyO',1000,'ROBO BANK 000111');
insert into u_user(u_email,u_password,u_account_balance,u_self_account) values('lola@gmail.com','$2a$10$5DPuFlMrLq551aWUs7TSOu/2rQuTJjy390w.Qtcj43THkbmzeO0wO',2000,'CMB BANK 000222');
insert into u_user(u_email,u_password,u_account_balance,u_self_account) values('greg@gmail.com','$2a$10$Ejtklk/hcN2OfE7HPauFPucY92c6j2YbolIqkqIS486H2Gqbe/dn.',3000,'CL BANK 000333');
insert into u_user(u_email,u_password,u_account_balance,u_self_account) values('aria@gmail.com','$2a$10$qUEqMNx6InrnlazunpJapO9NB5l3QTSbS4f94PKuglCEImvrrgBD6',4000,'BNP BANK 000444');
